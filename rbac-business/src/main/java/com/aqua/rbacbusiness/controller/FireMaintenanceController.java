...
public class FireMaintenanceController {
     ...
     */
    @PostMapping("/delete")
    @AuthCheck(permissionName = "删除日常维护记录数据的权限", requirePermission = "fireMaintenance:delete")
     ...
     */
    @PostMapping("/update")
    @AuthCheck(permissionName = "更新日常维护记录的权限", requirePermission = "fireMaintenance:update")
     ...
     */
    @GetMapping("/get/{id}")
    @AuthCheck(permissionName = "获取单个消防设备维护信息的权限", requirePermission = "fireMaintenance:selectOne")
     ...
     */
    @GetMapping("/list")
    @AuthCheck(permissionName = "获取消防设备维护信息列表", requirePermission = "fireMaintenance:list")
